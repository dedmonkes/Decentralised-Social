            ...
            <Carousel>
                <div className="box-container no-fill p-5 text-white">
                    ...
                    <p className="mb-4 text-sm font-light opacity-75">
                        I would like to create a storyboard as a first step for
                        a graphic novel for PopHeadz. I have experience in the
                        comics industry and have storyboarded 40+ existing
                        novels.{" "}
                    </p>
